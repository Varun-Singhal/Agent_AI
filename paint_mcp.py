...
async def select_paint_tool() -> dict:
    ...
    try:
        ...
        return {
            "content": [TextContent(type="text", text="Paint selected successfully")]
        }
        ...
        return {
            "content": [
                TextContent(type="text", text=f"Error selecting paint tool: {str(e)}")
            ]
        }
...
async def drop_paint_to_canvas() -> dict:
    ...
    try:
        ...
        return {
            "content": [
                TextContent(type="text", text="Paint dropped to canvas successfully")
            ]
        }
    except Exception as e:
...
async def open_paint() -> dict:
    ...
    try:
        ...
        logger.debug(
            f"Current paint_controller.paint_app: {paint_controller.paint_app}"
        )
        ...
        win32gui.SetWindowPos(
            ...
            win32con.HWND_TOP,
            primary_width + 1,
            0,  # Position it on secondary monitor
            0,
            0,  # Let Windows handle the size
